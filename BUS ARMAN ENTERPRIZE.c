...
int main()
{
   ...
   // printf("\n\t\t\t        =                 SYSTEM                    =");
    ...
    //done
    printf("[Welcome to ARMAN ENTERPRIZE]\n");
    ...
    if(start==1)
    {
        ...
        printf("\nDear %s, welcome to ARMAN ENTERPRIZE!!!",user_name);
...
void details_of_booking_ticket_khulna()
{
    ...
    if(coach_for_Khulna==1)
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,32-37-81");
        printf("\nSupervisor Name : ABDULLA AL AHAD ARMAN");
    ...
    else
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,55-55-55");
        printf("\nSupervisor Name : FARIA ISLAM");
        printf("\nSupervisor Phone Number : 01646736484\n");
    }
}
...
void details_of_booking_ticket_khulna_back()
{
    ...
    else if(coach_for_Khulna==2)
    {
        ...
        printf("\nSupervisor Phone Number : 01646667724\n");
    }
    ...
    else if(coach_for_Khulna==3)
    {
        ...
        printf("\nSupervisor Phone Number : 01646234564\n");
    }
    ...
    else
    {
        ...
        printf("\nDeparture Time : 11:00 am");
        printf("\nBus Number: Dhaka Metro-HA,55-55-55");
        printf("\nSupervisor Name : MAHIDUL ISLAM PRANTO");
        printf("\nSupervisor Phone Number : 01649834824\n");
    }
}
...
void details_of_booking_ticket_Rajshahi()
{
    ...
    if(coach_for_Rajshahi==1)
    {
        ...
        printf("\nDeparture Time : 7:00 am");
        printf("\nBus Number: Dhaka Metro-HA,22-27-51");
        printf("\nSupervisor Name : AINUR AKTER URMI");
        printf("\nSupervisor Phone Number : 01846798824\n");
    }
    ...
    else if(coach_for_Rajshahi==3)
    {
        ...
        printf("\nDeparture Time : 6:00 pm");
        printf("\nBus Number: Dhaka Metro-HA,42-57-42");
        printf("\nSupervisor Name : SHHAHINUR AKTER ONNI");
        printf("\nSupervisor Phone Number : 01823751824\n");
    }
    ...
    else
    {
        ...
        printf("\nDeparture Time : 11:00 am");
        printf("\nBus Number: Dhaka Metro-HA,57-75-55");
        printf("\nSupervisor Name : ASHFI RAHMAN");
        printf("\nSupervisor Phone Number : 016467394301\n");
    }
}
...
void details_of_booking_ticket_Rajshahi_back()
{
    ...
    if(coach_for_Rajshahi==1)
    {
        ...
        printf("\nDeparture Time : 7:00 am");
        printf("\nBus Number: Dhaka Metro-HA,22-27-51");
        printf("\nSupervisor Name : FATEMA AKTER ALAINA");
        printf("\nSupervisor Phone Number : 01715522583\n");
    }
    ...
    else
    {
        ...
        printf("\nBus Number: Dhaka Metro-HA,57-75-55");
        printf("\nSupervisor Name : ISFAQ HOSSAIN IBON");
        printf("\nSupervisor Phone Number : 01987653298\n");
    }
}
...
void details_of_booking_ticket_Comilla()
{
    ...
    if(coach_for_Comilla==1)
    {
        ...
        printf("Departure Time : 7:00 am");
        printf("\nBus Number: Dhaka Metro-HA,12-27-51");
        printf("\nSupervisor Name : RAHAT MAHMUD JOY");
        printf("\nSupervisor Phone Number : 01546756824\n");
    }
    ...
    else if(coach_for_Comilla==2)
    {
        ...
        printf("Departure Time : 12:00 pm");
        printf("\nBus Number: Dhaka Metro-LA,82-88-91");
        printf("\nSupervisor Name : HABBIUBR RAHMAN BAPPI");
        printf("\nSupervisor Phone Number : 01946788824\n");
    }
...
void details_of_booking_ticket_Comilla_back()
{
    ...
    else
    {
        ...
        printf("Departure Time : 11:00 am");
        printf("\nBus Number: Dhaka Metro-HA,55-75-45");
        printf("\nSupervisor Name : M.R.MOLY");
        printf("\nSupervisor Phone Number : 0162423619\n");
    }
}
...
void details_of_booking_ticket_Chittagong()
{
    ...
    else
    {
        ...
        printf("Departure Time : 11:00 am");
        printf("\nBus Number: Dhaka Metro-HA,55-65-46");
        printf("\nSupervisor Name : EASTAYEK ANIK");
        printf("\nSupervisor Phone Number : 01646784532\n");
    }
}
...
void payment()
{
    ...
    if(payment==1)
    {
        ...
        printf("\nStep 1.Make sure your payment to (01626423619) this number.");
